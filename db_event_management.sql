...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2025 at 07:22 PM
...
INSERT INTO `tbl_assigned_tasks` (`assigned_task_id`, `reservation_id`, `employee_id`, `truck_id`, `driver_id`, `assigned_by`, `created_at`) VALUES
(134, 229, 50, 2, 49, 'owner01', '2025-05-11 21:14:11');
...
INSERT INTO `tbl_reservations` (`reservation_id`, `user_id`, `ucount`, `rdate`, `status`, `bdate`, `end_time`, `address`, `service_type`) VALUES
(229, 89, '0984564534', '2025-05-13 15:00:00', 'APPROVED', '2025-05-11 21:12:55', '2025-05-13 16:30:00', '99 เดอะคอนเนค1 ประเวศ ประเวศ 10400', 'ดูดปฏิกูล'),
(230, 1, '', '2025-11-05 15:00:00', 'SUCCESS', '2025-11-04 15:35:59', '2025-11-05 16:30:00', '123 Bangkok Rd.', 'ดูดปฏิกูล'),
(231, 60, '', '2025-11-05 15:00:00', 'PENDING', '2025-11-04 16:41:36', '2025-11-05 16:30:00', '201 เดอะคอนเนค ซอยประเวศ แขวงประเวศ เขตประเวศ 10450', 'ดูดปฏิกูล');
...
--
-- Dumping data for table `tbl_revenue_updates`
--

INSERT INTO `tbl_revenue_updates` (`revenue_id`, `reservation_id`, `booking_date`, `updated_amount`, `item_description`, `quantity`, `unit_price`, `withholding_tax`, `issued_by`, `updated_at`, `receipt_image`) VALUES
(58, 230, '2025-11-05 15:00:00', 7760.00, 'ดูดสิ่งปฏิกูล', 2, 4000.00, 1, 1, '2025-11-04 15:38:33', '1762245513_receipt.jpg');
...
(89, 'วรากร', 'โชคสมัย', 'samdriver', '123456', '99 เดอะคอนเนค1 ประเวศ ประเวศ 10400', '0806454894', 'sam@gmail.com', 'user', 'active'),
...
--
ALTER TABLE `tbl_assigned_tasks`
  MODIFY `assigned_task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
...
--
ALTER TABLE `tbl_reservations`
  MODIFY `reservation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=232;
